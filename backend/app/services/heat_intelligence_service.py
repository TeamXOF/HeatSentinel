...
async def _execute_heat_intelligence_background(
    ...
    try:
        ...
        # Poll for completion with a 600s timeout (accommodating cloud queue rendering times)
        final_status = await client.poll_until_complete(activity_id, timeout_seconds=600, interval_seconds=3.0)
